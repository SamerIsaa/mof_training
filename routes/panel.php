    ...
    Route::group(['prefix' => 'panel'], function () {
        ...
        Route::group(['middleware' => 'auth:admin'], function () {
            ...
            Route::group(['prefix' => 'features', 'as' => 'features.'], function () {
                ...
                Route::get('/datatable', 'FeatureController@datatable')->name('datatable');

                Route::group(['prefix' => 'create'], function () {
                    Route::get('/', ['as' => 'create', 'uses' => 'FeatureController@create']);
                    Route::post('/', ['as' => 'store', 'uses' => 'FeatureController@store']);
                });
